  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12">
      <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <h1 className="mt-6 text-center font-heading text-xl font-bold text-slate-900">
          Welcome back
        </h1>
        <p className="mt-1 text-center text-sm text-slate-500">Log in to continue to Findora</p>
        ...
        <div className="mt-6 rounded-xl bg-slate-50 p-3 text-center text-xs text-slate-500">
          Demo logins (after running <code className="rounded bg-slate-200 px-1">npm run seed</code>):
          <br />
